"""
Django settings for tee_time_booking_ap_46495 project.
...
ROOT_URLCONF = 'tee_time_booking_ap_46495.urls'
...
WSGI_APPLICATION = 'tee_time_booking_ap_46495.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tee_time_booking_ap_46495 API",
    "DESCRIPTION": "API documentation for tee_time_booking_ap_46495 App",
    "VERSION": "v1",
}
